...
class DashboardService {
    ...
    async getDashboardSummary() {
        ...
        const liabilityPayments = (0, liabilityCashFlow_1.getTotalLiabilityMonthlyPayments)(liabilities);
    ...
    async getExpenseBreakdown() {
        ...
        liabilities.forEach(liability => {
            const payment = (0, liabilityCashFlow_1.getLiabilityMonthlyPayment)(liability);
            if (payment > 0) {
    ...
    async getRecentValueUpdates(limit = 15) {
        const query = `
      (
